...
// import Payment from "./pages/Paymentconst 
...
const UserRoute = lazy(() => import("./components/nav/routes/UserRoute"))
const Password = lazy(() => import("./pages/user/Password"))
const Wishlist = lazy(() => import("./pages/user/Wishlist"))
const AdminRoute = lazy(() => import("./components/nav/routes/AdminRoute"))
